...
class AtrixPubsub {
	...
	async start() {
		...
		this.publish = this.service.publish = ascoltatore.publishAsync.bind(ascoltatore); // eslint-disable-line no-multi-assign
		this.subscribe = this.service.subscribe = ascoltatore.subscribeAsync.bind(ascoltatore); // eslint-disable-line no-multi-assign
		return {
			publish: ascoltatore.publishAsync.bind(ascoltatore),
			subscribe: ascoltatore.subscribeAsync.bind(ascoltatore),
		};
	}
